...
PROPERTY.Name = "Old Industrial";
PROPERTY.Category = "Business";
PROPERTY.Description = "A Small Industrial House With A Storage And A Big Courtyard. Placed In Industrial Area.";
PROPERTY.Image = "ev17x_oldindustrialfirm";
