...
NPC.Location = {Vector(-7070.520020, -7894.643066, 60.0313), Vector(-6908.999023, -9667.961914, 60.0313), Vector(-7342.716797, -4497.762207, 60.0313), Vector(-7369.046387, -6158.024414, 60.0313)};
NPC.Angles = {Angle(0, 0, 0), Angle(0, 90, 0), Angle(0, -90, 0), Angle(0, -180, 0)};
