...
ITEM.InventoryModel 		= "models/weapons/w_smg_mp5.mdl";
ITEM.ModelCamPos 				= Vector(14, 42, 0);
ITEM.ModelLookAt 				= Vector(12, 0, 0);
ITEM.ModelFOV 					= 70;
ITEM.WorldModel 			= "models/weapons/w_smg_mp5.mdl";
...
if SERVER then
	...
	function ITEM.Equip ( Player )
		Player:Give("weapon_perp_mp5");
	end
	
	function ITEM.Holster ( Player )
		Player:StripWeapon("weapon_perp_mp5");
	end
